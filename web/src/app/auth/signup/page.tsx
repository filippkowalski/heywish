...
export default function SignUpPage() {
  ...
  const { user, signUpWithEmail, upgradeAnonymousAccount, signInWithGoogle } = useAuth();
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            {user?.isAnonymous ? 'Complete Your Account' : 'Create your account'}
          </h2>
          {user?.isAnonymous && (
            <p className="mt-2 text-center text-sm text-gray-600">
              Save your wishlists by creating an account
            </p>
          )}
          {!user?.isAnonymous && (
            <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <form className="space-y-6" onSubmit={handleSignUp}>
              ...
              <div>
                ...
                >
                  {loading ? 'Creating account...' : user?.isAnonymous ? 'Complete Registration' : 'Sign up'}
                </button>
              </div>
            </form>

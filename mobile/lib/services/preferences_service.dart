...
class PreferencesService extends ChangeNotifier {
  ...
  static const String _lastUsedWishlistIdKey = 'last_used_wishlist_id';
  ...
  String? get lastUsedWishlistId => _lastUsedWishlistId;
  ...
  Future<void> initialize() async {
    ...
    _lastUsedWishlistId = _prefs?.getString(_lastUsedWishlistIdKey);
    notifyListeners();
  }
  ...
  Future<void> setLastUsedWishlistId(String? value) async {
    _lastUsedWishlistId = value;
    if (value != null) {
      await _prefs?.setString(_lastUsedWishlistIdKey, value);
    } else {
      await _prefs?.remove(_lastUsedWishlistIdKey);
    }
    notifyListeners();
  }
